...
public class copyipad extends ViewGroup {
    int[] source = new int[]{R.color.fen_color1,R.color.lan_color2,R.color.cheng_color3,R.color.hong_color4,
            R.color.lv_color1,R.color.hui_color4,R.color.fen_color1,R.color.lan_color2,R.color.cheng_color3,R.color.hong_color4,
            R.color.lv_color1,R.color.hui_color4};
    private int count;
    private int front;
...
//                removeCallbacks(loop);
            ...
            case MotionEvent.ACTION_MOVE:
                if (alwysIn && ((x - lastx > 50) || (x - lastx < -50) || (y - lasty > 50) || (y - lasty < -50)))
                    alwysIn = false;
                if (!alwysIn)
...
//            postDelayed(loop, time + delaytime);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            child.layout(left, 20, left + vieww, H_v);
        }
