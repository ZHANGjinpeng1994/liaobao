...
//        mIat.setParameter(SpeechConstant.ASR_AUDIO_PATH, APP.FILE_VOICE_CACHE + "iat.wav");
    }
...
//            Toast.makeText(context, ""+error.getPlainDescription(true),0).show();
        }
